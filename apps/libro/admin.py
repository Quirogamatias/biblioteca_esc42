...
admin.site.register(Entrega_libro_Administrador)
admin.site.register(Entrega_libro_Profesor)
admin.site.register(Devolucion_libro)
admin.site.register(Devolucion_libro_Profesor)
admin.site.register(Reserva,ReservaAdmin)
admin.site.register(Alumno_Sancionado)
