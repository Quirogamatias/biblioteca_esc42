...
class Entrega_libro_Administrador(models.Model):
    id = models.AutoField(primary_key= True)    
    ...
    def natural_key(self):
        #return str(self.fecha_entrega)
        return f'{self.id_usuario}, Libro:  {self.id_libro}'
        
    class Meta:
        verbose_name = 'entrega del libro no reservado por el administrador'
        verbose_name_plural = 'entrega de libros no reservados por el administrador'
        ordering = ['fecha_entrega']
...
class Entrega_libro_Profesor(models.Model):
    id = models.AutoField(primary_key= True)    
    ...
    def natural_key(self):
        #return str(self.fecha_entrega)
        return f'{self.id_profesor}, Libro:  {self.id_libro}'
        
    class Meta:
        verbose_name = 'Entrega del libro al profesor'
        verbose_name_plural = 'Entrega de libros al profesor'
        ordering = ['fecha_entrega']
...
class Devolucion_libro(models.Model):
    ...
    def natural_key(self):
        ...
        return f'{self.id_entrega}, Fecha de devolucion del libro: {self.fecha_devolucion}'
        
    class Meta:
        verbose_name = 'devolucion del libro a la biblioteca'
        verbose_name_plural = 'devolucion del libro a la biblioteca'
        ordering = ['fecha_devolucion']

    def __str__(self):
        return f'{self.id_entrega}, Fecha de devolucion del libro: {self.fecha_devolucion}'

class Devolucion_libro_Profesor(models.Model):
    id = models.AutoField(primary_key= True)
    id_entrega_profesor = models.ForeignKey(Entrega_libro_Profesor, on_delete=models.CASCADE)
    fecha_devolucion = models.DateField('fecha de devolucion',blank= False,null=False)
    cantidad = models.PositiveIntegerField('Cantidad o Stock',default = 1)
    fecha_creacion = models.DateField('Fecha de creacion', auto_now=True,auto_now_add=False)
    estado = models.BooleanField(default = True,verbose_name = 'Estado')
    ...
    def natural_key(self):
        return str(self.fecha_devolucion)
        return f'{self.id_entrega_profesor}, Fecha de devolucion del libro: {self.fecha_devolucion}'
        
    class Meta:
        verbose_name = 'devolucion del libro por el profesor'
        verbose_name_plural = 'devolucion de libros por el profesor'
        ordering = ['fecha_devolucion']

    def __str__(self):
        return f'{self.id_entrega_profesor}, Fecha de devolucion del libro: {self.fecha_devolucion}'

class Alumno_Sancionado(models.Model):
    id_alumno_sacionado = models.AutoField(primary_key= True)  
    id_usuario = models.ForeignKey(Usuario, on_delete=models.CASCADE)    
    id_libro = models.ForeignKey(Libro, on_delete=models.CASCADE) 
    e = (
        ('Buena','Buena'),
    ...
    def natural_key(self):
        #return self.apellido
        return f'Alumno {self.id_usuario}, libro {self.id_libro}'
    class Meta:
        verbose_name = 'Alumno Sancionado'
        verbose_name_plural = 'Alumnos sancionados'
        ordering = ['id_usuario']

    def __str__(self):
        return f'Alumno {self.id_usuario}, libro {self.id_libro}'

#estos dos son para el admin, pero me generan inconvenientes en el localhost
...
#def __str__(self):
 #       return 'El nombre del banco es: {}'.format(self.bankName) 
