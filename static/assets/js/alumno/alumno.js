    ...
    $.ajax({
        ...
        success: function(response){
            ...
            for(let i = 0;i < response.length;i++){
                ...
                fila += ' onclick = "abrir_modal_edicion(\'/libro/editar_alumno/' + response[i]['pk']+'/\');"> EDITAR </button>';
                fila += '<button type = "button" class = "btn btn-danger tableButton btn-sm"';
                fila += 'onclick = "abrir_modal_eliminacion(\'/libro/eliminar_alumno/'+ response[i]['pk']+'/\');"> ELIMINAR </button>';
                fila += '<button type = "button" class = "btn btn-info tableButton btn-sm"';
                fila += 'onclick="location.href=(\'/usuarios/cambiar_passwordA/'+ response[i]['pk']+'/\');"> cambiar contraseña </button> </td>';
                fila += '</tr>';
    ...
    $.ajax({
        ...
        success: function(response){
            ...
            for(let i = 0;i < response.length;i++){
                ...
                fila += '<td>' + response[i]["fields"]['telefono'] + '</td>';
                fila += '<td> <button type = "button" class = "btn btn-primary btn-sm tableButton"';
                fila += ' onclick = "abrir_modal_edicion(\'/libro/editar_alumnoA/' + response[i]['pk']+'/\');"> EDITAR </button> </td>';
                fila += '</tr>';
